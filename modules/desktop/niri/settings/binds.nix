_: {
  programs.niri.settings.binds = {
    ...
    # Screenshot & Tool Binds
    "Alt+Print".action.screenshot-window = [ ];
    "Alt+XF86Launch1".action.screenshot-window = [ ];
    "Ctrl+Print".action.screenshot-screen = [ ];
    "Ctrl+XF86Launch1".action.screenshot-screen = [ ];
    "Ctrl+Shift+S".action.spawn = [ "wayland-scan-ocr" ];
    "Ctrl+Shift+Q".action.spawn = [ "wayland-scan-qr" ];
    "Mod+Shift+A".action.spawn = [ "wayland-scan-annotate" ];
    "Super+Shift+S".action.screenshot = [ ];
    "XF86Launch1".action.screenshot = [ ];
    "Mod+Shift+E".action.quit = [ ];

    # Shell Switch (hot-swap DMS ↔ Noctalia without logout)
    "Ctrl+Alt+S".action.spawn = [ "niri-shell-switch" ];
  };
}

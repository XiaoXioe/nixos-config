...
selfLib.mkModule {
  ...
  hmConfig = {
    programs.librewolf = {
      ...
      policies = {
        ExtensionSettings = {
          "*" = { installation_mode = "blocked"; blocked_install_message = "Ekstensi harus dideklarasikan di librewolf.nix!"; };
          ...
          "{b86e4813-687a-43e6-ab65-0bde4ab75758}" = { install_url = "https://addons.mozilla.org/firefox/downloads/latest/localcdn-fork-of-decentraleyes/latest.xpi"; installation_mode = "force_installed"; };
      ...
      profiles.${config.my.user.name} = {
        ...
        bookmarks = {
          force = true;
          settings = [
            { name = "Github Trending"; url = "https://trendshift.io/"; }
            { name = "Convert curl commands to Python, JavaScript and more"; url = "https://curlconverter.com/"; }
            { name = "The Cyber Swiss Army Knife"; url = "https://gchq.github.io/CyberChef/"; }
          ];
        };
      };
      settings = {

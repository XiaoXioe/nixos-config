...
Singleton {
    ...
    animation: QtObject {
        readonly property bool isLowPerf: Config.ready && Config.options.performance.lowPerformanceMode

        property QtObject elementMove: QtObject {
            property int duration: isLowPerf ? 0 : 500
        ...
        property QtObject elementMoveEnter: QtObject {
            property int duration: isLowPerf ? 0 : 400
            property int type: Easing.BezierSpline
        ...
        property QtObject elementMoveExit: QtObject {
            property int duration: isLowPerf ? 0 : 200
            property int type: Easing.BezierSpline
        ...
        property QtObject elementResize: QtObject {
            property int duration: isLowPerf ? 0 : 300
            property int type: Easing.BezierSpline
